...
class HLdap
{
    ...
    {
	Yii::log('----------------------------'.$username,'trace');
	//$username = $this->ldap->getCanonicalAccountName($username, Zend_Ldap::ACCTNAME_FORM_DN);
	//$username = $this->ldap->getCanonicalAccountName("uid=".$username.",ou=people,dc=conabio,dc=gob,dc=mx", Zend_Ldap::ACCTNAME_FORM_DN);
	$username = $this->ldap->getCanonicalAccountName("uid=".$username.",ou=people,dc=conabio,dc=gob,dc=mx");
	//$username = $this->ldap->getCanonicalAccountName("uid=carlos.alonso,ou=people,dc=conabio,dc=gob,dc=mx", Zend_Ldap::ACCTNAME_FORM_DN);
	//$username = $this->ldap->getCanonicalAccountName('ggonzalez', Zend_Ldap::ACCTNAME_FORM_DN);
        try {
