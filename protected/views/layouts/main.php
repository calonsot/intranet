...
<head>
    ...
    <link href="<?php echo Yii::app()->baseUrl; ?>/js/jquery-ui-1.11.4.custom/jquery-ui.min.css?ver=<?php echo $ver; ?>" rel="stylesheet">
    <!-- end: CSS -->
    ...
    <script type="text/javascript" src="<?php echo Yii::app()->baseUrl; ?>/js/jquery-ui-1.11.4.custom/jquery-ui.min.js?ver=<?php echo $ver; ?>"></script>
